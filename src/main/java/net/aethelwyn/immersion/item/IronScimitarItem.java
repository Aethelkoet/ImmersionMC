...
public class IronScimitarItem extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:iron_scimitar")
	public static final Item block = null;
	public IronScimitarItem(ImmersionModElements instance) {
		super(instance, 88);
	}
