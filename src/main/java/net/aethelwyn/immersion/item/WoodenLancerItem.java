...
public class WoodenLancerItem extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:wooden_lancer")
	public static final Item block = null;
	public WoodenLancerItem(ImmersionModElements instance) {
		super(instance, 460);
	}
