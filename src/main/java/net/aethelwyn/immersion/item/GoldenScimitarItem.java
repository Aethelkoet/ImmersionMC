...
public class GoldenScimitarItem extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:golden_scimitar")
	public static final Item block = null;
	public GoldenScimitarItem(ImmersionModElements instance) {
		super(instance, 87);
	}
