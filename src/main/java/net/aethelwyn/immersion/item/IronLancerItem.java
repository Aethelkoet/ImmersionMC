...
public class IronLancerItem extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:iron_lancer")
	public static final Item block = null;
	public IronLancerItem(ImmersionModElements instance) {
		super(instance, 463);
	}
