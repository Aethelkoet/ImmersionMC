...
public class JuicedAppleBottleItem extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:juiced_apple_bottle")
	public static final Item block = null;
	public JuicedAppleBottleItem(ImmersionModElements instance) {
		super(instance, 130);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("juiced_apple_bottle");
		}
