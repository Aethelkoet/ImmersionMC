...
public class PROCSawmillGiveSlot1Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot1Procedure(ImmersionModElements instance) {
		super(instance, 229);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot1!");
			return;
		}
