...
public class FermenterIngredientPROCProcedure extends ImmersionModElements.ModElement {
	public FermenterIngredientPROCProcedure(ImmersionModElements instance) {
		super(instance, 276);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if ((!((new Object() {
				...
				world.addParticle(ParticleTypes.COMPOSTER, x, y, z, Math.random(), Math.random(), Math.random());
				if ((!(new Object() {
			...
			if ((!((new Object() {
				...
				if ((!(new Object() {
					...
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(Items.SWEET_BERRIES, (int) (1));
						((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
								((PlayerEntity) entity).container.func_234641_j_());
					}
				}
			...
			if ((!((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Blocks.CACTUS, (int) (1)).getItem()))) {
				if (entity instanceof LivingEntity) {
					((LivingEntity) entity).swing(Hand.MAIN_HAND, true);
				}
				{
				...
				if ((!(new Object() {
					...
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(Blocks.CACTUS, (int) (1));
						((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
								((PlayerEntity) entity).container.func_234641_j_());
					}
				}
			...
			if ((!((new Object() {
				...
				if ((!(new Object() {
					...
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(Items.CHORUS_FRUIT, (int) (1));
						((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
								((PlayerEntity) entity).container.func_234641_j_());
					}
				}
			...
			if ((!((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.BEETROOT, (int) (1)).getItem()))) {
				if (entity instanceof LivingEntity) {
					((LivingEntity) entity).swing(Hand.MAIN_HAND, true);
				}
				{
				...
				if ((!(new Object() {
					...
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(Items.BEETROOT, (int) (1));
						((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
								((PlayerEntity) entity).container.func_234641_j_());
					}
				}
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(GrapesItem.block, (int) (1)).getItem()))) {
				if (entity instanceof LivingEntity) {
					((LivingEntity) entity).swing(Hand.MAIN_HAND, true);
				}
				{
