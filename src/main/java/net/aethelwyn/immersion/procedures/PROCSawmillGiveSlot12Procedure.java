...
public class PROCSawmillGiveSlot12Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot12Procedure(ImmersionModElements instance) {
		super(instance, 240);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot12!");
			return;
		}
