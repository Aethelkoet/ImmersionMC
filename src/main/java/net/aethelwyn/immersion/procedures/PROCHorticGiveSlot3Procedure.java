...
public class PROCHorticGiveSlot3Procedure extends ImmersionModElements.ModElement {
	public PROCHorticGiveSlot3Procedure(ImmersionModElements instance) {
		super(instance, 438);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCHorticGiveSlot3!");
			return;
		}
