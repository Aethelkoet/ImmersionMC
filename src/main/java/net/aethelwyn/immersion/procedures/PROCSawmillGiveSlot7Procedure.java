...
public class PROCSawmillGiveSlot7Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot7Procedure(ImmersionModElements instance) {
		super(instance, 235);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot7!");
			return;
		}
