...
public class PROCSawmillGiveSlot9Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot9Procedure(ImmersionModElements instance) {
		super(instance, 237);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot9!");
			return;
		}
