...
public class PROCSawmillGiveSlot8Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot8Procedure(ImmersionModElements instance) {
		super(instance, 236);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot8!");
			return;
		}
