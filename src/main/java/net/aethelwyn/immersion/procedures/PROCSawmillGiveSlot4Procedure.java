...
public class PROCSawmillGiveSlot4Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot4Procedure(ImmersionModElements instance) {
		super(instance, 232);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot4!");
			return;
		}
