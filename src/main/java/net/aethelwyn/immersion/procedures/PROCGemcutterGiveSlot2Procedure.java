...
public class PROCGemcutterGiveSlot2Procedure extends ImmersionModElements.ModElement {
	public PROCGemcutterGiveSlot2Procedure(ImmersionModElements instance) {
		super(instance, 355);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCGemcutterGiveSlot2!");
			return;
		}
