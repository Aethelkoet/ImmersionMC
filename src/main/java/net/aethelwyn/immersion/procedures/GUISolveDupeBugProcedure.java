...
public class GUISolveDupeBugProcedure extends ImmersionModElements.ModElement {
	public GUISolveDupeBugProcedure(ImmersionModElements instance) {
		super(instance, 442);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		} else if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == SawmillBlock.block.getDefaultState().getBlock())) {
			if ((!(new Object() {
				public boolean checkGamemode(Entity _ent) {
					if (_ent instanceof ServerPlayerEntity) {
						return ((ServerPlayerEntity) _ent).interactionManager.getGameType() == GameType.CREATIVE;
		...
		} else if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == GemcutterTableBlock.block.getDefaultState()
				.getBlock())) {
			if ((!(new Object() {
				public boolean checkGamemode(Entity _ent) {
					if (_ent instanceof ServerPlayerEntity) {
