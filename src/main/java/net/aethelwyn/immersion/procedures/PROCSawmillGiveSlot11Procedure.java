...
public class PROCSawmillGiveSlot11Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot11Procedure(ImmersionModElements instance) {
		super(instance, 239);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot11!");
			return;
		}
