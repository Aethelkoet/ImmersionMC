...
public class PROCSawmillGiveSlot10Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot10Procedure(ImmersionModElements instance) {
		super(instance, 238);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot10!");
			return;
		}
