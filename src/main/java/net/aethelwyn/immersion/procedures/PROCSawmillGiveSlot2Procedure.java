...
public class PROCSawmillGiveSlot2Procedure extends ImmersionModElements.ModElement {
	public PROCSawmillGiveSlot2Procedure(ImmersionModElements instance) {
		super(instance, 230);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCSawmillGiveSlot2!");
			return;
		}
