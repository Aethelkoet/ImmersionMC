...
public class PROCGemcutterGiveSlot1Procedure extends ImmersionModElements.ModElement {
	public PROCGemcutterGiveSlot1Procedure(ImmersionModElements instance) {
		super(instance, 354);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ImmersionMod.LOGGER.warn("Failed to load dependency entity for procedure PROCGemcutterGiveSlot1!");
			return;
		}
