...
public class ChorusPlanksBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_planks")
	public static final Block block = null;
	public ChorusPlanksBlock(ImmersionModElements instance) {
		super(instance, 65);
	}
