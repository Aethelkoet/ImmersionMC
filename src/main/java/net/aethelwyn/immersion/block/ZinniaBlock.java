...
public class ZinniaBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:zinnia")
	public static final Block block = null;
	public ZinniaBlock(ImmersionModElements instance) {
		super(instance, 80);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("zinnia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:zinnia"), configuredFeature);
		}
	}
	@SubscribeEvent
