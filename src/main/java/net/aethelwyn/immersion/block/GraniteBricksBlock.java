...
public class GraniteBricksBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:granite_bricks")
	public static final Block block = null;
	public GraniteBricksBlock(ImmersionModElements instance) {
		super(instance, 24);
	}
