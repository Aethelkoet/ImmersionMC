...
public class StrippedChorusLogBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:stripped_chorus_log")
	public static final Block block = null;
	public StrippedChorusLogBlock(ImmersionModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_chorus_log");
		}
