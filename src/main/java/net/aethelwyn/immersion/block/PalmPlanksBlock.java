...
public class PalmPlanksBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:palm_planks")
	public static final Block block = null;
	public PalmPlanksBlock(ImmersionModElements instance) {
		super(instance, 640);
	}
