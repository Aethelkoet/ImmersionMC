...
public class GraniteBrickSlabBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:granite_brick_slab")
	public static final Block block = null;
	public GraniteBrickSlabBlock(ImmersionModElements instance) {
		super(instance, 26);
	}
