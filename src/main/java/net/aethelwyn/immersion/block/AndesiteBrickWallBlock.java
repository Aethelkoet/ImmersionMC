...
public class AndesiteBrickWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:andesite_brick_wall")
	public static final Block block = null;
	public AndesiteBrickWallBlock(ImmersionModElements instance) {
		super(instance, 7);
	}
