...
public class ChorusWoodBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_wood")
	public static final Block block = null;
	public ChorusWoodBlock(ImmersionModElements instance) {
		super(instance, 62);
	}
