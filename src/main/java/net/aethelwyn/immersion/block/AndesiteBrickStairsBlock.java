...
public class AndesiteBrickStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:andesite_brick_stairs")
	public static final Block block = null;
	public AndesiteBrickStairsBlock(ImmersionModElements instance) {
		super(instance, 5);
	}
