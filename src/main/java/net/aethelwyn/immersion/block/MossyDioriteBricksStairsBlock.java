...
public class MossyDioriteBricksStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mossy_diorite_bricks_stairs")
	public static final Block block = null;
	public MossyDioriteBricksStairsBlock(ImmersionModElements instance) {
		super(instance, 20);
	}
