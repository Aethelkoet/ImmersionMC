...
public class ChorusDoorBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_door")
	public static final Block block = null;
	public ChorusDoorBlock(ImmersionModElements instance) {
		super(instance, 137);
	}
