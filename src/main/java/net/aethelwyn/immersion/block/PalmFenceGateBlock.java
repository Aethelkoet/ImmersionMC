...
public class PalmFenceGateBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:palm_fence_gate")
	public static final Block block = null;
	public PalmFenceGateBlock(ImmersionModElements instance) {
		super(instance, 644);
	}
