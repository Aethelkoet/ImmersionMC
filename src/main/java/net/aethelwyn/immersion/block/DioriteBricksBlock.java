...
public class DioriteBricksBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:diorite_bricks")
	public static final Block block = null;
	public DioriteBricksBlock(ImmersionModElements instance) {
		super(instance, 14);
	}
