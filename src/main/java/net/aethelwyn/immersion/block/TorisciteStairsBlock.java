...
public class TorisciteStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:toriscite_stairs")
	public static final Block block = null;
	public TorisciteStairsBlock(ImmersionModElements instance) {
		super(instance, 557);
	}
