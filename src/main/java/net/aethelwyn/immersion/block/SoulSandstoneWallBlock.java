...
public class SoulSandstoneWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:soul_sandstone_wall")
	public static final Block block = null;
	public SoulSandstoneWallBlock(ImmersionModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("soul_sandstone_wall");
		}
