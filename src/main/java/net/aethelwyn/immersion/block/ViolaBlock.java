...
public class ViolaBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:viola")
	public static final Block block = null;
	public ViolaBlock(ImmersionModElements instance) {
		super(instance, 82);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("viola"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:viola"), configuredFeature);
		}
	}
	@SubscribeEvent
