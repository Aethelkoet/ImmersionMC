...
public class MudBricksWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mud_bricks_wall")
	public static final Block block = null;
	public MudBricksWallBlock(ImmersionModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.WET_GRASS).hardnessAndResistance(1.2f, 2.5f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("mud_bricks_wall");
		}
