...
public class DioriteBrickStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:diorite_brick_stairs")
	public static final Block block = null;
	public DioriteBrickStairsBlock(ImmersionModElements instance) {
		super(instance, 15);
	}
