...
public class DioriteBrickWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:diorite_brick_wall")
	public static final Block block = null;
	public DioriteBrickWallBlock(ImmersionModElements instance) {
		super(instance, 17);
	}
