...
public class PalmTrapdoorBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:palm_trapdoor")
	public static final Block block = null;
	public PalmTrapdoorBlock(ImmersionModElements instance) {
		super(instance, 645);
	}
