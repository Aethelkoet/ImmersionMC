...
public class NiterOreBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:niter_ore")
	public static final Block block = null;
	public NiterOreBlock(ImmersionModElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3.5f, 3f).setLightLevel(s -> 0).harvestLevel(2)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("niter_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("immersion:niter_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 9)).range(39)
					.square().func_242731_b(6);
			event.getRegistry().register(feature.setRegistryName("niter_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:niter_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
