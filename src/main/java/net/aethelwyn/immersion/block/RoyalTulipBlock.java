...
public class RoyalTulipBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:royal_tulip")
	public static final Block block = null;
	public RoyalTulipBlock(ImmersionModElements instance) {
		super(instance, 84);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("royal_tulip"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:royal_tulip"), configuredFeature);
		}
	}
	@SubscribeEvent
