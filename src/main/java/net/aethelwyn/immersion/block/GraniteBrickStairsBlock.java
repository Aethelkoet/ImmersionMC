...
public class GraniteBrickStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:granite_brick_stairs")
	public static final Block block = null;
	public GraniteBrickStairsBlock(ImmersionModElements instance) {
		super(instance, 25);
	}
