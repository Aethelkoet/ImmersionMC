...
public class CobbledTorisciteWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:cobbled_toriscite_wall")
	public static final Block block = null;
	public CobbledTorisciteWallBlock(ImmersionModElements instance) {
		super(instance, 562);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cobbled_toriscite_wall");
		}
