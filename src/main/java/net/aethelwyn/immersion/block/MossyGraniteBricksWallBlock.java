...
public class MossyGraniteBricksWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mossy_granite_bricks_wall")
	public static final Block block = null;
	public MossyGraniteBricksWallBlock(ImmersionModElements instance) {
		super(instance, 31);
	}
