...
public class TorisciteBrickStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:toriscite_brick_stairs")
	public static final Block block = null;
	public TorisciteBrickStairsBlock(ImmersionModElements instance) {
		super(instance, 563);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("toriscite_brick_stairs");
		}
