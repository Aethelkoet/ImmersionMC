...
public class MossyGraniteBricksStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mossy_granite_bricks_stairs")
	public static final Block block = null;
	public MossyGraniteBricksStairsBlock(ImmersionModElements instance) {
		super(instance, 29);
	}
