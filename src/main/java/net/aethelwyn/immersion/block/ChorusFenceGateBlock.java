...
public class ChorusFenceGateBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_fence_gate")
	public static final Block block = null;
	public ChorusFenceGateBlock(ImmersionModElements instance) {
		super(instance, 139);
	}
