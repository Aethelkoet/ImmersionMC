...
public class AndesiteBricksBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:andesite_bricks")
	public static final Block block = null;
	public AndesiteBricksBlock(ImmersionModElements instance) {
		super(instance, 4);
	}
