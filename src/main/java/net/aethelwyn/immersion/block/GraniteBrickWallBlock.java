...
public class GraniteBrickWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:granite_brick_wall")
	public static final Block block = null;
	public GraniteBrickWallBlock(ImmersionModElements instance) {
		super(instance, 27);
	}
