...
public class RopeBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:rope")
	public static final Block block = null;
	public RopeBlock(ImmersionModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOL).sound(SoundType.CLOTH).hardnessAndResistance(0.1f, 2f).setLightLevel(s -> 0).harvestLevel(1)
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case EAST :
				case WEST :
					return VoxelShapes.or(makeCuboidShape(7, 9, 0, 9, 7, 16)).withOffset(offset.x, offset.y, offset.z);
				case UP :
				case DOWN :
					return VoxelShapes.or(makeCuboidShape(0, 9, 9, 16, 7, 7)).withOffset(offset.x, offset.y, offset.z);
			}
		}
