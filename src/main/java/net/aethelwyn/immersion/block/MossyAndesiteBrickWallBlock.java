...
public class MossyAndesiteBrickWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mossy_andesite_brick_wall")
	public static final Block block = null;
	public MossyAndesiteBrickWallBlock(ImmersionModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_andesite_brick_wall");
		}
