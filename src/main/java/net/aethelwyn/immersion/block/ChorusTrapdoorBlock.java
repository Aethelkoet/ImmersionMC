...
public class ChorusTrapdoorBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_trapdoor")
	public static final Block block = null;
	public ChorusTrapdoorBlock(ImmersionModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("chorus_trapdoor");
		}
