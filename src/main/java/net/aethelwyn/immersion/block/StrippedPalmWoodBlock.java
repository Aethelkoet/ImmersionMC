...
public class StrippedPalmWoodBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:stripped_palm_wood")
	public static final Block block = null;
	public StrippedPalmWoodBlock(ImmersionModElements instance) {
		super(instance, 639);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_palm_wood");
		}
