...
public class StrippedPalmLogBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:stripped_palm_log")
	public static final Block block = null;
	public StrippedPalmLogBlock(ImmersionModElements instance) {
		super(instance, 638);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_palm_log");
		}
