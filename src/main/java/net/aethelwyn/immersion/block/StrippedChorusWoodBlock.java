...
public class StrippedChorusWoodBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:stripped_chorus_wood")
	public static final Block block = null;
	public StrippedChorusWoodBlock(ImmersionModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_chorus_wood");
		}
