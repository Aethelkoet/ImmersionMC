...
public class ChorusSlabBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_slab")
	public static final Block block = null;
	public ChorusSlabBlock(ImmersionModElements instance) {
		super(instance, 67);
	}
