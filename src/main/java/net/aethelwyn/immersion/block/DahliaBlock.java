...
public class DahliaBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:dahlia")
	public static final Block block = null;
	public DahliaBlock(ImmersionModElements instance) {
		super(instance, 81);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dahlia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:dahlia"), configuredFeature);
		}
	}
	@SubscribeEvent
