...
public class TorisciteBrickWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:toriscite_brick_wall")
	public static final Block block = null;
	public TorisciteBrickWallBlock(ImmersionModElements instance) {
		super(instance, 565);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("toriscite_brick_wall");
		}
