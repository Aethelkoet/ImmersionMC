...
public class ChorusFenceBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_fence")
	public static final Block block = null;
	public ChorusFenceBlock(ImmersionModElements instance) {
		super(instance, 73);
	}
