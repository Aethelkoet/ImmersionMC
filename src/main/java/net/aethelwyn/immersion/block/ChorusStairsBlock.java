...
public class ChorusStairsBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_stairs")
	public static final Block block = null;
	public ChorusStairsBlock(ImmersionModElements instance) {
		super(instance, 66);
	}
