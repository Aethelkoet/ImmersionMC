...
public class MyosotisBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:myosotis")
	public static final Block block = null;
	public MyosotisBlock(ImmersionModElements instance) {
		super(instance, 83);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("myosotis"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:myosotis"), configuredFeature);
		}
	}
	@SubscribeEvent
