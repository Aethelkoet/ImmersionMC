...
public class ChorusLogBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:chorus_log")
	public static final Block block = null;
	public ChorusLogBlock(ImmersionModElements instance) {
		super(instance, 61);
	}
