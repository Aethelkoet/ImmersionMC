...
public class AndesiteBrickSlabBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:andesite_brick_slab")
	public static final Block block = null;
	public AndesiteBrickSlabBlock(ImmersionModElements instance) {
		super(instance, 6);
	}
