...
public class MossyDioriteBricksWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:mossy_diorite_bricks_wall")
	public static final Block block = null;
	public MossyDioriteBricksWallBlock(ImmersionModElements instance) {
		super(instance, 22);
	}
