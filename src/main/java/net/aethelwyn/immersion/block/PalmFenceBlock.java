...
public class PalmFenceBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:palm_fence")
	public static final Block block = null;
	public PalmFenceBlock(ImmersionModElements instance) {
		super(instance, 643);
	}
