...
public class TorisciteNiterOreBlock extends ImmersionModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("immersion:toriscite_niter_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 6)).range(9).square()
					.func_242731_b(2);
			event.getRegistry().register(feature.setRegistryName("toriscite_niter_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("immersion:toriscite_niter_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
