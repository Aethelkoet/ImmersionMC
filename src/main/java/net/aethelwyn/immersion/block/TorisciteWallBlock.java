...
public class TorisciteWallBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:toriscite_wall")
	public static final Block block = null;
	public TorisciteWallBlock(ImmersionModElements instance) {
		super(instance, 559);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("toriscite_wall");
		}
