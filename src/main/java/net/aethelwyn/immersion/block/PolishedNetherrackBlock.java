...
public class PolishedNetherrackBlock extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:polished_netherrack")
	public static final Block block = null;
	public PolishedNetherrackBlock(ImmersionModElements instance) {
		super(instance, 46);
	}
