...
public class CurseOfTauntingEnchantment extends ImmersionModElements.ModElement {
	@ObjectHolder("immersion:curse_of_taunting")
	public static final Enchantment enchantment = null;
	public CurseOfTauntingEnchantment(ImmersionModElements instance) {
		super(instance, 593);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("curse_of_taunting"));
	}
